...
//        }
        ...
        System.out.println("test:"+(kakaoUser.getTel().equals("KakaoTel")));

        if(kakaoUser.getTel().equals("KakaoTel")){
            kakaoUser.setTel("test");
        }
        System.out.println("kakaoUsertel : "+ kakaoUser.getTel());
